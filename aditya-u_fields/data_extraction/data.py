...
major_radius = 0.75
minor_radius = 0.25
coil_current_tf_coils = 7500 # 7.5kA per loop --> 45kA for 6 loops
...
grid = pv.PolyData(obs_points)
grid["magnetic_field"] = np.column_stack((Bx, By, Bz))

volume = grid.delaunay_3d(alpha=2.0) # Create a 3D Delaunay triangulation of the grid points

# Save the grid to a VTK file
volume.save("magnetic_field.vtk")
